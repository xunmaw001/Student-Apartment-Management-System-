            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">公寓管理</li>
                        <li class="breadcrumb-item active">编辑公寓</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                louyuTypes: "楼宇不能为空",
                susheName: "公寓号不能为空",
                susheLouceng: "公寓楼层不能为空",
                susheAddress: "公寓位置不能为空",
